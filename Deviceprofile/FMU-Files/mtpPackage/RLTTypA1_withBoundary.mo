...
model RLTTypA1_withBoundary "Generic air-handling unit with heat recovery system"
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary_a2(redeclare package Medium = Medium1, nPorts = 1) annotation(
    Placement(visible = true, transformation(origin = {352, 80}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  Modelica.Fluid.Sources.Boundary_pT boundary_a4(redeclare package Medium = Medium2, nPorts = 1) annotation(
    Placement(visible = true, transformation(origin = {0, -132}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Fluid.Sources.Boundary_pT boundary_b4(redeclare package Medium = Medium2, nPorts = 1) annotation(
    Placement(visible = true, transformation(origin = {-20, -172}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Fluid.Sources.Boundary_pT boundary_a5(redeclare package Medium = Medium2, nPorts = 1) annotation(
    Placement(visible = true, transformation(origin = {40, -132}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Fluid.Sources.Boundary_pT boundary_b5(redeclare package Medium = Medium2, nPorts = 1) annotation(
    Placement(visible = true, transformation(origin = {22, -172}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
...
equation
  ...
  connect(boundary_b2.ports[1], port_b2) annotation(
    Line(points = {{-300, 80}, {-250, 80}}, color = {0, 127, 255}));
  connect(boundary_a1.ports[1], port_a1) annotation(
    Line(points = {{-300, 0}, {-250, 0}}, color = {0, 127, 255}));
  ...
  connect(boundary_b4.ports[1], port_b4) annotation(
    Line(points = {{-20, -162}, {-20, -100}}, color = {0, 127, 255}));
  connect(boundary_a4.ports[1], port_a4) annotation(
    Line(points = {{0, -122}, {0, -100}}, color = {0, 127, 255}));
  connect(boundary_b5.ports[1], port_b5) annotation(
    Line(points = {{22, -162}, {20, -162}, {20, -100}}, color = {0, 127, 255}));
  connect(boundary_a5.ports[1], port_a5) annotation(
    Line(points = {{40, -122}, {40, -100}}, color = {0, 127, 255}));
  connect(boundary_b1.ports[1], port_b1) annotation(
    Line(points = {{340, 0}, {300, 0}}, color = {0, 127, 255}));
  connect(boundary_a2.ports[1], port_a2) annotation(
    Line(points = {{342, 80}, {300, 80}}, color = {0, 127, 255}));
  connect(setFlaps.y, genericAHUBus_extended.flapEhaSet) annotation(
    Line(points = {{-99, 150}, {0, 150}, {0, 120}}, color = {0, 0, 127}));
  ...
  connect(dpFansSet.y, genericAHUBus_extended.dpFanEtaSet) annotation(
    Line(points = {{-59, 170}, {0, 170}, {0, 120}}, color = {0, 0, 127}));
  ...
  connect(humidiferSet.y, genericAHUBus_extended.humSetSup) annotation(
    Line(points = {{-19, 190}, {0, 190}, {0, 120}}, color = {0, 0, 127}));
  annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-250, -100}, {300, 120}}), graphics = {Rectangle(origin = {0, 10}, fillColor = {170, 255, 127}, fillPattern = FillPattern.Solid, lineThickness = 1, extent = {{-200, 90}, {200, -90}}), Text(origin = {0, 10}, extent = {{-200, 90}, {200, -90}}, textString = "RLT TYP A1", fontSize = 72)}),
