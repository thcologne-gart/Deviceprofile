...
model Test_Heizkreis_TypB
  ...
  mtpPackage.Heizkreis_TypB heizkreis_TypB(
...
equation
  ...
  connect(boundaryIn.ports[1], heizkreis_TypB.port_a1) annotation(
    Line(points = {{-80, -20}, {-50, -20}}, color = {0, 127, 255}));
  connect(boundaryOut.ports[1], heizkreis_TypB.port_b2) annotation(
    Line(points = {{-80, -80}, {-50, -80}}, color = {0, 127, 255}));
  connect(heizkreis_TypB.port_b1, heizkreis_TypB.port_a2) annotation(
    Line(points = {{50, -20}, {78, -20}, {78, -80}, {50, -80}}, color = {0, 127, 255}));
  connect(hydraulicBus, heizkreis_TypB.hydraulicBus) annotation(
    Line(points = {{0, 50}, {0, 0}}, color = {255, 204, 51}, thickness = 0.5));
end Test_Heizkreis_TypB;
