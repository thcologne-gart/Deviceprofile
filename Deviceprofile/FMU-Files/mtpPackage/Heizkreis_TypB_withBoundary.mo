...
model Heizkreis_TypB_withBoundary "Modell für Heizkreis Typ B-Beimischschaltung"
...
equation
  ...
  connect(valve.port_1, port_a1) annotation(
    Line(points = {{-142, 80}, {-198, 80}}, color = {0, 127, 255}));
  connect(pipe1.port_a, valve.port_2) annotation(
    Line(points = {{-80, 80}, {-122, 80}}, color = {0, 127, 255}));
  connect(valve.port_3, pipe5.port_b) annotation(
    Line(points = {{-132, 70}, {-132, 10}}, color = {0, 127, 255}));
  connect(ramp.y, valve.y) annotation(
    Line(points = {{-158, 130}, {-132, 130}, {-132, 92}}, color = {0, 0, 127}));
  connect(pipe4.port_b, junc45.ports[1]) annotation(
    Line(points = {{-80, -80}, {-132, -80}}, color = {0, 127, 255}));
  connect(junc45.ports[2], pipe5.port_a) annotation(
    Line(points = {{-132, -80}, {-132, -10}}, color = {0, 127, 255}));
  connect(junc45.ports[3], port_b2) annotation(
    Line(points = {{-132, -80}, {-200, -80}}, color = {0, 127, 255}));
  ...
  connect(senT_b1.T, PT1_b1.u) annotation(
    Line(points = {{148, 92}, {148, 118}}, color = {0, 0, 127}));
...
end Heizkreis_TypB_withBoundary;
