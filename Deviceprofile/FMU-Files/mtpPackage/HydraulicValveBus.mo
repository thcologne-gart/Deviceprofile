...
expandable connector HydraulicValveBus "Data bus for hydraulic circuits"
  extends Modelica.Icons.SignalBus;
  import Modelica.Units.SI;
  AixLib.Fluid.Movers.PumpsPolynomialBased.BaseClasses.PumpBus pumpBus;
  Real valve1Set(min = 0, max = 1) "Valve opening setpoint 0..1";
  Real valve1Mea(min = 0, max = 1) "Actual valve opening 0..1";
  Real valve2Set(min = 0, max = 1) "Valve opening setpoint 0..1";
  Real valve2Mea(min = 0, max = 1) "Actual valve opening 0..1";
