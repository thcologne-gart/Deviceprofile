...
model RLTTypB1_withBoundary "Generic air-handling unit with heat recovery system"
  ...
  AixLib.Fluid.Humidifiers.GenericHumidifier_u humidifierSup(redeclare package Medium = Medium1, allowFlowReversal = allowFlowReversal1, energyDynamics = energyDynamics, m_flow_nominal = m1_flow_nominal) if useHumidifier "Steam or adiabatic humdifier in supply canal" annotation(
  ...
  Modelica.Blocks.Sources.Constant valveSet(k = 0) annotation(
...
equation
  ...
  connect(setFlaps.y, genericAHUBus_extended.flapSupSet) annotation(
    Line(points = {{-98, 230}, {0, 230}, {0, 180}}, color = {0, 0, 127}));
  connect(pumpSet.y, pump.y) annotation(
    Line(points = {{-58, 210}, {-30, 210}, {-30, 62}}, color = {0, 0, 127}));
  connect(valveSet.y, genericAHUBus_extended.y1) annotation(
    Line(points = {{20, 230}, {0, 230}, {0, 180}}, color = {0, 0, 127}));
  connect(valveSet.y, genericAHUBus_extended.y2) annotation(
    Line(points = {{20, 230}, {0, 230}, {0, 180}}, color = {0, 0, 127}));
  connect(valveSet.y, genericAHUBus_extended.y3) annotation(
    Line(points = {{20, 230}, {0, 230}, {0, 180}}, color = {0, 0, 127}));
