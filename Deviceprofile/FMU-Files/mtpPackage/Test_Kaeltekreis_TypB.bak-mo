...
//-----block cooling circuit-----
  mtpPackage.Kaeltekreis_TypB kaeltekreis_TypB(
...
equation
  ...
  connect(hydraulicBus, kaeltekreis_TypB.hydraulicBus) annotation(
    Line(points = {{0, 50}, {0, 0}}, color = {255, 204, 51}, thickness = 0.5));
  connect(kaeltekreis_TypB.port_b1, kaeltekreis_TypB.port_a2) annotation(
    Line(points = {{50, -20}, {80, -20}, {80, -80}, {50, -80}}, color = {0, 127, 255}));
  connect(boundaryIn.ports[1], kaeltekreis_TypB.port_a1) annotation(
    Line(points = {{-80, -20}, {-50, -20}}, color = {0, 127, 255}));
  connect(boundaryOut.ports[1], kaeltekreis_TypB.port_b2) annotation(
    Line(points = {{-80, -80}, {-50, -80}}, color = {0, 127, 255}));
annotation(
    experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-6, Interval = 0.002),
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
    __OpenModelica_simulationFlags(lv = "LOG_STATS", s = "dassl"));
end Test_Kaeltekreis_TypB;
